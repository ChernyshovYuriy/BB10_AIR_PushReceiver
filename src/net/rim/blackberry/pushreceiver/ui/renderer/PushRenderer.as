...
package net.rim.blackberry.pushreceiver.ui.renderer
{
	...
	{		
		...
		{					
			...
			deleteIcon.setImage("../../../../../../assets/images/trash.png");
		...
		{					
			...
			if (push.contentType == Push.CONTENT_TYPE_IMAGE) {
				pushTypeIcon.setImage("../../../../../../assets/images/pictures.png");
				pushPreview.text = "Image: " + push.fileExtension;
			} else if (push.contentType == Push.CONTENT_TYPE_TEXT) {	
				pushTypeIcon.setImage("../../../../../../assets/images/memo.png");
				...
				pushTypeIcon.setImage("../../../../../../assets/images/browser.png");
		...
		{			
			...
			deleteIcon.setImage("../../../../../../assets/images/trashhighlight.png");
