...
{	
	...
	import net.rim.blackberry.pushreceiver.service.ConfigurationService;
	import net.rim.blackberry.pushreceiver.service.ConfigurationServiceImpl;
	...
	public class PushReceiver extends Sprite
	{
		...
		{							
			...
			var configAction:Action = new Action(ActionBarHelper.CONFIG_ACTION_LABEL, "assets/images/configicon.png");
			actionBar.addAction(configAction);
			
			var registerAction:Action = new Action(ActionBarHelper.REGISTER_ACTION_LABEL, "assets/images/registericon.png");
			actionBar.addAction(registerAction);
			
			var unregisterAction:Action = new Action(ActionBarHelper.UNREGISTER_ACTION_LABEL, "assets/images/unregistericon.png");
			actionBar.addAction(unregisterAction);
			
			var markAllAction:Action = new Action(ActionBarHelper.MARK_ALL_OPEN_ACTION_LABEL, "assets/images/markallicon.png");
			markAllAction.actionBarPlacement = ActionPlacement.IN_OVERFLOW;
			actionBar.addAction(markAllAction);
			
			var deleteAllAction:Action = new Action(ActionBarHelper.DELETE_ALL_OPEN_ACTION_LABEL, "assets/images/deleteallicon.png");
